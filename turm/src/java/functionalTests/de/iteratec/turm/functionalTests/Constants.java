...
public final class Constants {
  ...
  public static final String LOGIN_FORM_LOGINFIELD    = "j_username";
  public static final String LOGIN_FORM_PASSWORDFIELD = "j_password";
  public static final String LOGOUT_LINK              = "logout_link";
  public static final String PASSWORD_URL             = "password"; // relative to servlet context path 
  public static final String DEFAULT_USER             = "system";
  public static final String DEFAULT_PASSWORD         = "password";
  public static final String TITLE                    = "iTURM - iteratec Tiny User Role Management";
