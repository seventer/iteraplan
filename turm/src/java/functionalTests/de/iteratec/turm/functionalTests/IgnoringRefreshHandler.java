...
/**
 * This refresh handler does nothing.
 * 
 * All refresh instructions are ignored, the original page will be kept.
 * This can be useful if you want to test the page that contains the
 * refresh.
 */
public class IgnoringRefreshHandler implements RefreshHandler {
