...
/**
 * Used for creating a prepared insert or update statement.
 */
public class UpdateStatement {

  /** The insert or update statement with parameters. */
  private final String   query;

  /** The parameter values for the statement. */
  private final Object[] params;

  public UpdateStatement(String query, Object... params) {
    super();
    this.query = query;
    this.params = params;
  }
