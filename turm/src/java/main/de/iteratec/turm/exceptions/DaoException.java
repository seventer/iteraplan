...
/**
 * Superclass for all exceptions that can be thrown by DAO classes.
 */
public class DaoException extends TurmException {

  private static final long serialVersionUID = -3325737025593451912L;
