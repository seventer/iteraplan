...
--
insert into im_user(id, olVersion, loginName, firstName, lastName, password, lastPasswordChange) values((select max(nextId) from im_id_table), 0, 'system', '-', '-', '5F4DCC3B5AA765D61D8327DEB882CF99', sysdate);
update im_id_table set nextId=(nextId+1);
...
--
insert into im_user(id, olVersion, loginName, firstName, lastName, password, lastPasswordChange) values((select max(nextId) from im_id_table), 0, 'admin', 'Administrator', '-', '5F4DCC3B5AA765D61D8327DEB882CF99', sysdate);
update im_id_table set nextId=(nextId+1);
insert into im_user_has_role(im_user_id, im_role_id) values ((select max(id) from im_user), (select max(id) from im_role));
...
--
insert into im_user(id, olVersion, loginName, firstName, lastName, password, lastPasswordChange) values((select max(nextId) from im_id_table), 0, 'sue', 'Sue', '-', '5F4DCC3B5AA765D61D8327DEB882CF99', sysdate);
update im_id_table set nextId=(nextId+1);
insert into im_user_has_role(im_user_id, im_role_id) values ((select max(id) from im_user), (select max(id) from im_role));
...
--
insert into im_user(id, olVersion, loginName, firstName, lastName, password, lastPasswordChange) values((select max(nextId) from im_id_table), 0, 'Joe', 'Joe', '-', '5F4DCC3B5AA765D61D8327DEB882CF99', sysdate);
update im_id_table set nextId=(nextId+1);
insert into im_user_has_role(im_user_id, im_role_id) values ((select max(id) from im_user), (select max(id) from im_role));
...
--
insert into im_user(id, olVersion, loginName, firstName, lastName, password, lastPasswordChange) values((select max(nextId) from im_id_table), 0, 'bob', 'Bob', '-', '5F4DCC3B5AA765D61D8327DEB882CF99', sysdate);
update im_id_table set nextId=(nextId+1);
insert into im_user_has_role(im_user_id, im_role_id) values ((select max(id) from im_user), (select max(id) from im_role));
...
--
insert into im_user(id, olVersion, loginName, firstName, lastName, password, lastPasswordChange) values((select max(nextId) from im_id_table), 0, 'cio', '-', '-', '5F4DCC3B5AA765D61D8327DEB882CF99', sysdate);
update im_id_table set nextId=(nextId+1);
insert into im_user_has_role(im_user_id, im_role_id) values ((select max(id) from im_user), (select max(id) from im_role));
...
--
insert into im_user(id, olVersion, loginName, firstName, lastName, password, lastPasswordChange) values((select max(nextId) from im_id_table), 0, 'tom', 'Tom', '-', '5F4DCC3B5AA765D61D8327DEB882CF99', sysdate);
update im_id_table set nextId=(nextId+1);
insert into im_user_has_role(im_user_id, im_role_id) values ((select max(id) from im_user), (select max(id) from im_role));
...
--
insert into im_user(id, olVersion, loginName, firstName, lastName, password, lastPasswordChange) values((select max(nextId) from im_id_table), 0, 'mainuser', 'MainUser', '-', '5F4DCC3B5AA765D61D8327DEB882CF99', sysdate);
update im_id_table set nextId=(nextId+1);
insert into im_user_has_role(im_user_id, im_role_id) values ((select max(id) from im_user), (select max(id) from im_role));
