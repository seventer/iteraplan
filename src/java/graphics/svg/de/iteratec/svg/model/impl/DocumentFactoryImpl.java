...
public class DocumentFactoryImpl extends DocumentFactory {
  ...
  private static final DocumentFactoryImpl INSTANCE = new DocumentFactoryImpl();
  ...
  @Override
  public Document loadDocument(InputStream stream) throws IOException, ParserConfigurationException, SAXException, SvgExportException {
    return new DocumentImpl(stream);
  }
