...
public class LayoutGraph implements Serializable {

  private Set<LayoutNode> nodes;
  private Set<LayoutEdge> edges;

  private Dimension       graphDimension;

  public LayoutGraph() {
    nodes = new HashSet<LayoutNode>();
    edges = new HashSet<LayoutEdge>();
    graphDimension = new Dimension(0, 0);
  }
  ...
  public void setNodes(Set<LayoutNode> nodes) {
    this.nodes = nodes;
  }
