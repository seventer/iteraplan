...
/**
 * Implementation of the DAO interface {@link BusinessFunctionDAO}.
 */
public class BusinessFunctionDAOImpl extends GenericHierarchicalDAO<BusinessFunction, Integer> implements BusinessFunctionDAO {

  /** {@inheritDoc} */
  @Override
  protected void onBeforeDelete(BusinessFunction entity) {
    ...
    Set<BusinessFunction> set = new HashSet<BusinessFunction>();
    ...
    for (BusinessFunction bf : set) {
      bf.removeRelations();
      getHibernateTemplate().delete(bf);
    }
