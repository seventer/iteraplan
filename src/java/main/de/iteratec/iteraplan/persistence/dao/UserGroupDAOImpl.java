...
/**
 * Implementation of the DAO interface {@link UserGroupDAO}.
 */
public class UserGroupDAOImpl extends GenericBaseDAO<UserGroup, Integer> implements UserGroupDAO {
  ...
  /** {@inheritDoc} */
  @Override
  protected void onBeforeDelete(UserGroup entity) {
