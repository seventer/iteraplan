...
/**
 * Hibernate implementation of the DAO interface {@link AssociationDAOTemplate}.
 * 
 ...
 */
public abstract class GenericAssociationDAO<L extends BuildingBlock, R extends BuildingBlock, A extends AbstractAssociation<L, R>> extends
    GenericBaseDAO<A, Integer> implements AssociationDAOTemplate<L, R, A> {
