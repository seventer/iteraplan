...
/**
 * The DAO interface for all entities of type {@link AbstractAssociation}.
 *  
 ...
 */
public interface AssociationDAOTemplate<L extends BuildingBlock, R extends BuildingBlock, A extends AbstractAssociation<L, R>> extends
    DAOTemplate<A, Integer> {
