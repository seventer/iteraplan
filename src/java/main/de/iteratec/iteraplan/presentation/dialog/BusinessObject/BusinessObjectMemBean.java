...
/**
 * Memory bean for the {@code BusinessObject} dialog.
 */
public class BusinessObjectMemBean extends CanHaveTimeseriesBaseMemBean<BusinessObject, BusinessObjectComponentModel> {

  /** Serialization version. */
  private static final long            serialVersionUID = -4398075071763211071L;
  private BusinessObjectComponentModel componentModel   = new BusinessObjectComponentModel(ComponentMode.READ);

  public BusinessObjectComponentModel getComponentModel() {
    return componentModel;
  }

  public void setComponentModel(BusinessObjectComponentModel componentModel) {
