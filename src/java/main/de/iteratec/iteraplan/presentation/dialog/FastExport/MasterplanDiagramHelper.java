...
public abstract class MasterplanDiagramHelper {

  public abstract List<BuildingBlock> determineResults(BuildingBlock start, DiagramVariant variant, MasterplanOptionsBean bean);
}
