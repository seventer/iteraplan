...
/**
 * Memory bean for the {@code BusinessUnit} dialog.
 */
public class BusinessUnitMemBean extends CanHaveTimeseriesBaseMemBean<BusinessUnit, BusinessUnitComponentModel> {

  /** Serialization version. */
  private static final long          serialVersionUID = 1294789715912034872L;
  private BusinessUnitComponentModel componentModel   = new BusinessUnitComponentModel(ComponentMode.READ);

  public BusinessUnitComponentModel getComponentModel() {
    return componentModel;
  }

  public void setComponentModel(BusinessUnitComponentModel componentModel) {
