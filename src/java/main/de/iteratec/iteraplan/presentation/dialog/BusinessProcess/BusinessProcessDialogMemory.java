...
public class BusinessProcessDialogMemory extends BuildingBlockSearchDialogMemory {

  private static final long serialVersionUID = 1L;

  @Override
  public List<Criterion> getCriteria() {
    List<Criterion> businessProcessCriteria = new ArrayList<Criterion>();
    businessProcessCriteria.add(new Criterion("fullTextSearchValue", "businessProcess.search.label.fullTextSearchValueField",
        "businessProcess.search.hint.fullTextSearchValueField"));
    return businessProcessCriteria;
  }

  @Override
  public List<ColumnDefinition> getInitialColumnDefinitions() {
    List<ColumnDefinition> props = new ArrayList<ColumnDefinition>();
    props.add(new ColumnDefinition("businessProcess.singular", "name", "", true));
