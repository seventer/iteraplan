...
public class InformationSystemDomainMemBean extends CanHaveTimeseriesBaseMemBean<InformationSystemDomain, InformationSystemDomainComponentModel> {

  /** Serialization version. */
  private static final long                     serialVersionUID = 8588049250825276260L;
  private InformationSystemDomainComponentModel componentModel   = new InformationSystemDomainComponentModel(ComponentMode.READ);

  public InformationSystemDomainComponentModel getComponentModel() {
    return this.componentModel;
  }

  public void setComponentModel(InformationSystemDomainComponentModel componentModel) {
  ...
  public boolean isHasInformationSystemReleases() {

    ManyAssociationSetComponentModel<InformationSystemDomain, InformationSystemRelease> isrModel = this.getComponentModel()
        .getInformationSystemReleaseModel();

    return (isrModel != null && !isrModel.getConnectedElements().isEmpty());
  }
}
