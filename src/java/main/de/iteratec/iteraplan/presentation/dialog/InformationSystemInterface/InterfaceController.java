...
@Controller
public class InterfaceController extends GuiSearchController<InformationSystemInterfaceDialogMemory> {
  ...
  @Autowired
  public InterfaceController(InformationSystemInterfaceService isiService) {
    this.isiService = isiService;
  }

  @Override
  protected InformationSystemInterfaceDialogMemory getDialogMemory() {
    return new InformationSystemInterfaceDialogMemory();
  }

  @Override
  protected String getDialogName() {
    return Dialog.INTERFACE.getDialogName();
  }
  ...
  /**
   * This method executes the search for specific interface
   * 
   * @param dialogMemory
   ...
   */
  @Override
  public PagedListHolder<?> searchAll(InformationSystemInterfaceDialogMemory dialogMemory, ModelMap model) {

    PagedListHolder<InformationSystemInterface> results = isiService.getInformationSystemInterfacesBySearch(
        dialogMemory.toInformationSystemInterface(), dialogMemory.getPageStart(), dialogMemory.getPageSize());
