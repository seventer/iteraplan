...
public class IteraQlDialogMemory extends DialogMemory {

  private static final long serialVersionUID      = 4491921028173570880L;

  private String            query                 = "";

  private Boolean           checkAllBox           = Boolean.TRUE;

  private List<String>      availableDestinations = null;

  private String            selectedDestination   = null;

  /**
   * contains the selected result ids, implemented like this for compatibility with {@link ManageReportBeanBase}
   * which is also used by ResultPageTile.jsp, like this DialogMemory
   */
  private final QueryResult queryResult           = new QueryResult("mainQuery");
