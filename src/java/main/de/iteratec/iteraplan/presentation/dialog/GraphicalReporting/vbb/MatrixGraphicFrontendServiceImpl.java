...
@Service("matrixGraphicFrontendService")
public class MatrixGraphicFrontendServiceImpl extends VbbGraphicFrontendService {
  ...
  protected ReportType getReportType() {
    return ReportType.MATRIX;
  }

  /**{@inheritDoc}**/
  @Override
  protected GraphicalReport getGraphicalReport() {
    return GraphicsResponseGenerator.GraphicalReport.MATRIX;
  }
