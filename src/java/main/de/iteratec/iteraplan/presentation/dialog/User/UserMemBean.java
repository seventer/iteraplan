...
/**
 * Memory bean for the User management page.
 */
public class UserMemBean extends BaseMemBean<User, UserComponentModel> {

  /** Serialization version. */
  private static final long  serialVersionUID = -5472814550120948146L;
  private UserComponentModel componentModel   = new UserComponentModel(ComponentMode.READ);

  public UserComponentModel getComponentModel() {
    return componentModel;
  }

  public void setComponentModel(UserComponentModel componentModel) {
