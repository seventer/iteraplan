...
public class InfrastructureElementMemBean extends CanHaveTimeseriesBaseMemBean<InfrastructureElement, InfrastructureElementComponentModel> {

  /** Serialization version. */
  private static final long                   serialVersionUID = -839304628397933245L;
  private InfrastructureElementComponentModel componentModel   = new InfrastructureElementComponentModel(ComponentMode.READ);

  public InfrastructureElementComponentModel getComponentModel() {
    return this.componentModel;
  }

  public void setComponentModel(InfrastructureElementComponentModel componentModel) {
  ...
  public boolean isHasAssociatedTechnicalComponents() {
    ...
    ManyAssociationSetComponentModel<InfrastructureElement, TechnicalComponentRelease> technicalModel = this.getComponentModel()
        .getTechnicalComponentReleaseModel();
