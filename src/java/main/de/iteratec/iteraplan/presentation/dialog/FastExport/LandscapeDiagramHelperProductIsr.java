 ...
 * @author est
 */
public class LandscapeDiagramHelperProductIsr extends LandscapeDiagramHelper<Product> {

  /**
   * @param startElement
   *          The information system release to start from.
   */
  public LandscapeDiagramHelperProductIsr(Product startElement, TypeOfBuildingBlock columnType, TypeOfBuildingBlock rowType) {
