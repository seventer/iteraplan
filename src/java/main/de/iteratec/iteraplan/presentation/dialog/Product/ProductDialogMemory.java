...
public class ProductDialogMemory extends BuildingBlockSearchDialogMemory {

  private static final long serialVersionUID = 1L;

  @Override
  public List<Criterion> getCriteria() {
    List<Criterion> productCriteria = new ArrayList<Criterion>();
    productCriteria.add(new Criterion("fullTextSearchValue", "product.search.label.fullTextSearchValueField",
        "product.search.hint.fullTextSearchValueField"));
  ...
  public List<ColumnDefinition> getInitialColumnDefinitions() {
    ...
    props.add(new ColumnDefinition("global.product", "name", "", true));
