...
public class ProjectDialogMemory extends SearchDialogMemory {

  /** Serialization version. */
  private static final long serialVersionUID = -2653847561024683324L;
  private String            projectName;

  @Override
  public List<Criterion> getCriteria() {
    List<Criterion> projectCriteria = new ArrayList<Criterion>();
    projectCriteria.add(new Criterion("fullTextSearchValue", "project.search.label.fullTextSearchValueField",
        "project.search.hint.fullTextSearchValueField"));
  ...
  public List<ColumnDefinition> getInitialColumnDefinitions() {
    ...
    props.add(new ColumnDefinition("project.singular", "name", "", true));
  ...
  public Project toProject() {
    ...
    result.setName(this.getProjectName());
    return result;
  }
