...
public class BusinessDomainMemBean extends CanHaveTimeseriesBaseMemBean<BusinessDomain, BusinessDomainComponentModel> {

  /** Serialization version. */
  private static final long            serialVersionUID = -6019210903017226741L;
  private BusinessDomainComponentModel componentModel   = new BusinessDomainComponentModel(ComponentMode.READ);

  public BusinessDomainComponentModel getComponentModel() {
    return componentModel;
  }

  public void setComponentModel(BusinessDomainComponentModel componentModel) {
