 ...
 * products.
 */
@Service("productFrontendService")
public class ProductFrontendServiceImpl extends TimeseriesCMBaseFrontendService<Product, ProductMemBean> {
  ...
  protected String getFlowId() {
    return Dialog.PRODUCT.getFlowId();
  }

  public boolean sortEverythingInComponentModel(ProductMemBean memBean, RequestContext context, FlowExecutionContext flowContext) {
  ...
  @Override
  protected Product createNewModelObject() {
    return BuildingBlockFactory.createProduct();
  }

  @Override
  protected ProductMemBean createNewMemBean() {
    return new ProductMemBean();
  }

  @Override
  protected ProductComponentModel createComponentModel(ProductMemBean memBean, ComponentMode componentMode) {
    ProductComponentModel cm = new ProductComponentModel(componentMode);
    memBean.setComponentModel(cm);
    return cm;
  }

  @Override
  protected void prepareBuildingBlockForCopy(Product buildingBlock) {
