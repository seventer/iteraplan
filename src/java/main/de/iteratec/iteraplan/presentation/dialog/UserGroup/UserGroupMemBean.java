...
/**
 * Memory bean for the Usergroup management page.
 */
public class UserGroupMemBean extends BaseMemBean<UserGroup, UserGroupComponentModel> {

  /** Serialization version. */
  private static final long       serialVersionUID = 5088143839552674719L;
  private UserGroupComponentModel componentModel   = new UserGroupComponentModel(ComponentMode.READ);

  public UserGroupComponentModel getComponentModel() {
    return componentModel;
  }

  public void setComponentModel(UserGroupComponentModel componentModel) {
