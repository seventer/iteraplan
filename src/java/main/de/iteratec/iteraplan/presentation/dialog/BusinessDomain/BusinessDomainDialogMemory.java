...
public class BusinessDomainDialogMemory extends BuildingBlockSearchDialogMemory {

  private static final long serialVersionUID = 1L;

  @Override
  public List<Criterion> getCriteria() {
    List<Criterion> businessDomainCriteria = new ArrayList<Criterion>();
    businessDomainCriteria.add(new Criterion("fullTextSearchValue", "businessDomain.search.label.fullTextSearchValueField",
        "businessDomain.search.hint.fullTextSearchValueField"));
    return businessDomainCriteria;
  }

  @Override
  public List<ColumnDefinition> getInitialColumnDefinitions() {
    List<ColumnDefinition> props = new ArrayList<ColumnDefinition>();
    props.add(new ColumnDefinition("businessDomain.singular", "name", "", true));
  ...
  public BusinessDomain toBusinessDomain() {
    BusinessDomain bd = new BusinessDomain();
    bd.setName(getName());
    bd.setDescription(getDescription());
