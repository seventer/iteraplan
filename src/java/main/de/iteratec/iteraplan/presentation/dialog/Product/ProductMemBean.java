...
public class ProductMemBean extends CanHaveTimeseriesBaseMemBean<Product, ProductComponentModel> {

  /** Serialization version. */
  private static final long     serialVersionUID = -5740413867691365613L;
  private ProductComponentModel componentModel   = new ProductComponentModel(ComponentMode.READ);

  public ProductComponentModel getComponentModel() {
    return componentModel;
  }

  public void setComponentModel(ProductComponentModel componentModel) {
