...
public abstract class BaseMemBean<S, T extends ComponentModel<S>> implements MemBean<S, T>, PagePosition, Serializable {
  private static final long serialVersionUID = 2522623524477236727L;
  ...
  public void validateCopyBB(Errors errors) {
    // delegate to validateEdit
    validateEdit(errors);
  }

  public abstract void validateEdit(Errors errors);
}
