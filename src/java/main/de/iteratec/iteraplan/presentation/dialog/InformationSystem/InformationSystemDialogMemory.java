...
public class InformationSystemDialogMemory extends BuildingBlockSearchDialogMemory {

  /** Serialization version. */
  private static final long serialVersionUID = 1396089230459421371L;

  @Override
  public List<Criterion> getCriteria() {
    List<Criterion> informationSystemCriteria = new ArrayList<Criterion>();
    informationSystemCriteria.add(new Criterion("fullTextSearchValue", "informationSystemRelease.search.label.fullTextSearchValueField",
        "informationSystemRelease.search.hint.fullTextSearchValueField"));
  ...
  public List<ColumnDefinition> getInitialColumnDefinitions() {
    ...
    props.add(new ColumnDefinition("informationSystem.singular", "name", "", true));
    ...
    ColumnDefinition statusColumn = new ColumnDefinition("global.type_of_status", "typeOfStatusAsString", "", true);
    statusColumn.setInternationalized(true);
    props.add(statusColumn);
    return props;
  }

  public InformationSystem toInformationSystem() {
