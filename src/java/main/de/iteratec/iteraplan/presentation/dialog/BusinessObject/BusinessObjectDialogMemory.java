...
public class BusinessObjectDialogMemory extends BuildingBlockSearchDialogMemory {

  private static final long serialVersionUID = 1L;

  @Override
  public List<Criterion> getCriteria() {
    List<Criterion> businessObjectCriteria = new ArrayList<Criterion>();
    businessObjectCriteria.add(new Criterion("fullTextSearchValue", "businessObject.search.label.fullTextSearchValueField",
        "businessObject.search.hint.fullTextSearchValueField"));
  ...
  public List<ColumnDefinition> getInitialColumnDefinitions() {
    ...
    props.add(new ColumnDefinition("businessObject.singular", "name", "", true));
