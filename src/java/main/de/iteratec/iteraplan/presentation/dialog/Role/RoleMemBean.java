...
public class RoleMemBean extends BaseMemBean<Role, RoleComponentModel> {

  /** Serialization version. */
  private static final long  serialVersionUID = -29144413145735450L;
  private RoleComponentModel componentModel   = new RoleComponentModel(ComponentMode.READ);

  public RoleComponentModel getComponentModel() {
    return componentModel;
  }

  public void setComponentModel(RoleComponentModel componentModel) {
