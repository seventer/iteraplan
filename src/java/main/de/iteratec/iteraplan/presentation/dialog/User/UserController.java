...
@Controller
public class UserController extends GuiSearchController<UserDialogMemory> {
  ...
  protected String getDialogName() {
    return Dialog.USER.getDialogName();
  }
  ...
  @Override
  protected UserDialogMemory getDialogMemory() {
    return new UserDialogMemory();
  }

  @Override
  public PagedListHolder<?> searchAll(UserDialogMemory dialogMemory, ModelMap model) {

    List<User> userList = userService.getUserBySearch(dialogMemory.toUser());
    PagedListHolder<User> results = new PagedListHolder<User>(userList);
