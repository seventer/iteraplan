...
@Service("timelineGraphicFrontendService")
public class TimelineGraphicFrontendServiceImpl extends VbbGraphicFrontendService {
  ...
  protected GraphicalReport getGraphicalReport() {
    return GraphicsResponseGenerator.GraphicalReport.TIMELINE;
  }
