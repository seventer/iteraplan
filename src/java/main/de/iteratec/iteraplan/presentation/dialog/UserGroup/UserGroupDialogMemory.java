...
/**
 * Dialog Memory Class of the User Group Context. Contains common parameters outside of the Spring
 * Webflow context like search parameters.
 */
public class UserGroupDialogMemory extends BuildingBlockSearchDialogMemory {
  ...
  public List<Criterion> getCriteria() {
    List<Criterion> userGroupCriteria = new ArrayList<Criterion>();
    userGroupCriteria.add(new Criterion("name", "global.usergroup", "manageUserGroup.search.hint.nameField"));
  ...
  public List<ColumnDefinition> getInitialColumnDefinitions() {
    ...
    props.add(new ColumnDefinition("global.usergroup", "name", "", true));
