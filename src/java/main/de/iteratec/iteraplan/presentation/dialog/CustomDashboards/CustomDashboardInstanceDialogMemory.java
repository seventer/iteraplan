...
public class CustomDashboardInstanceDialogMemory extends DialogMemory {
  private static final long             serialVersionUID = 1L;
  private CustomDashboardInstance       customDashboardInstance;
  private User                          author;
  private List<? extends BuildingBlock> queryResults;
  ...
  /**
   * @return queryResults the queryResults
   */
  public List<? extends BuildingBlock> getQueryResults() {
    return queryResults;
  }

  public void setQueryResults(List<? extends BuildingBlock> queryResults) {
