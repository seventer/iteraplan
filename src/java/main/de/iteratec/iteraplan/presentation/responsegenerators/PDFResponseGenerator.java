...
public class PDFResponseGenerator extends GraphicsResponseGenerator {
  ...
  protected void writeGraphics(GraphicExportBean graphicsBean, OutputStream outputStream) throws SvgExportException {
    SvgGraphicWriter.writeToPDF(graphicsBean.getDom(), outputStream);
  }
  ...
  public GraphicsResponseGenerator getInstance() {
    return new PDFResponseGenerator();
  }
