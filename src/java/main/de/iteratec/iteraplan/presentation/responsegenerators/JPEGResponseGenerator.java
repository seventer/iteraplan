...
public class JPEGResponseGenerator extends GraphicsResponseGenerator {
  ...
  protected void writeGraphics(GraphicExportBean graphicsBean, OutputStream outputStream) throws SvgExportException {
    SvgGraphicWriter.writeToJPEG(graphicsBean.getDom(), outputStream);
  }
  ...
  public GraphicsResponseGenerator getInstance() {
    return new JPEGResponseGenerator();
  }
