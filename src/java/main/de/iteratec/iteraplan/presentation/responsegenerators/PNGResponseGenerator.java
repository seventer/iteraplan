...
public class PNGResponseGenerator extends GraphicsResponseGenerator {
  ...
  protected void writeGraphics(GraphicExportBean graphicsBean, OutputStream outputStream) throws SvgExportException {
    SvgGraphicWriter.writeToPNG(graphicsBean.getDom(), outputStream);
  }
  ...
  public GraphicsResponseGenerator getInstance() {
    return new PNGResponseGenerator();
  }
