...
public class BusinessProcessModelBuilder extends BuildingBlockModelBuilder {

  private BusinessProcessChangeset changeSet;

  public BusinessProcessModelBuilder(BuildingBlock bb, HistoryBBChangeset changeSet, String applicationBaseUri) {
    super(bb, applicationBaseUri, changeSet);
    if (changeSet != null && ! (changeSet instanceof BusinessProcessChangeset)) {
      throw new IllegalArgumentException("expecting an BusinessProcessChangeSet");
    }

    this.changeSet = (BusinessProcessChangeset) changeSet;
  }
