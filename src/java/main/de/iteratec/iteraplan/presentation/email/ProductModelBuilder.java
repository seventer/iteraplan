...
public class ProductModelBuilder extends BuildingBlockModelBuilder {

  private ProductChangeset changeSet;

  public ProductModelBuilder(BuildingBlock bb, HistoryBBChangeset changeSet, String applicationBaseUri) {
    super(bb, applicationBaseUri, changeSet);
    if (changeSet != null && ! (changeSet instanceof ProductChangeset)) {
      throw new IllegalArgumentException("expecting an ProductChangeSet");
    }

    this.changeSet = (ProductChangeset) changeSet;
  }
