...
public class ArchitecturalDomainModelBuilder extends BuildingBlockModelBuilder {

  private ArchitecturalDomainChangeset changeSet;

  public ArchitecturalDomainModelBuilder(BuildingBlock bb, HistoryBBChangeset changeSet, String applicationBaseUri) {
    super(bb, applicationBaseUri, changeSet);
    if (changeSet != null && !(changeSet instanceof ArchitecturalDomainChangeset)) {
      throw new IllegalArgumentException("expecting an ArchitecturalDomainChangeSet");
    }
    this.changeSet = (ArchitecturalDomainChangeset) changeSet;
  }
