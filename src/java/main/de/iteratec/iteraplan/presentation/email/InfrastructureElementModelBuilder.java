...
public class InfrastructureElementModelBuilder extends BuildingBlockModelBuilder {

  private InfrastructureElementChangeset changeSet;

  public InfrastructureElementModelBuilder(BuildingBlock bb, HistoryBBChangeset changeSet, String applicationBaseUri) {
    super(bb, applicationBaseUri, changeSet);
    if (changeSet != null && !(changeSet instanceof InfrastructureElementChangeset)) {
      throw new IllegalArgumentException("expecting an InfrastructureElementChangeSet");
    }
    this.changeSet = (InfrastructureElementChangeset) changeSet;
  }
  ...
  public EmailModel createModel() {
    ...
    this.addChange(changes, "Uses Infrastructure Element", EmailModel.ADDED, changeSet.getBaseComponentsAdded());
    this.addChange(changes, "Uses Infrastructure Element", EmailModel.REMOVED, changeSet.getBaseComponentsRemoved());
    this.addChange(changes, "Used by Infrastructure Element", EmailModel.ADDED, changeSet.getParentComponentsAdded());
    this.addChange(changes, "Used by Infrastructure Element", EmailModel.REMOVED, changeSet.getParentComponentsRemoved());
