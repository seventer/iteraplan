...
public class InformationSystemDomainModelBuilder extends BuildingBlockModelBuilder {

  private InformationSystemDomainChangeset changeSet;

  public InformationSystemDomainModelBuilder(BuildingBlock bb, HistoryBBChangeset changeSet, String applicationBaseUri) {
    super(bb, applicationBaseUri, changeSet);
    if (changeSet != null && ! (changeSet instanceof InformationSystemDomainChangeset)) {
      throw new IllegalArgumentException("expecting an InformationSystemDomainChangeSet");
    }

    this.changeSet = (InformationSystemDomainChangeset) changeSet;
  }
