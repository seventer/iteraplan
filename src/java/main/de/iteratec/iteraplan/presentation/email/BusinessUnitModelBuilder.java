...
public class BusinessUnitModelBuilder extends BuildingBlockModelBuilder {

  private BusinessUnitChangeset changeSet;

  public BusinessUnitModelBuilder(BuildingBlock bb, HistoryBBChangeset changeSet, String applicationBaseUri) {
    super(bb, applicationBaseUri, changeSet);
    if (changeSet != null && ! (changeSet instanceof BusinessUnitChangeset)) {
      throw new IllegalArgumentException("expecting an BusinessUnitChangeSet");
    }

    this.changeSet = (BusinessUnitChangeset) changeSet;
  }
