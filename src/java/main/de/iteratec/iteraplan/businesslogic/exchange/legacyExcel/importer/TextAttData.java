...
/**
 * Represents imported entry for the text attribute.
 * @author sip
 */
public class TextAttData extends AttData {
  /** Multiline Attribute Values. */
  private CellValueHolder   multiline;
   ...
   * @param multiline
   */
  public TextAttData(CellValueHolder name, CellValueHolder oldName, CellValueHolder description, CellValueHolder groupName,
      CellValueHolder mandatory, CellValueHolder active, CellValueHolder multiline) {
    super(name, oldName, description, groupName, mandatory, active);
    this.multiline = multiline;
  }

  public CellValueHolder getMultiline() {
    return multiline;
  }

  public void setMultiline(CellValueHolder multiline) {
    this.multiline = multiline;
  }
