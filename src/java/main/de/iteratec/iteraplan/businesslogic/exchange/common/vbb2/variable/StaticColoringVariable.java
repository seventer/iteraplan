...
public class StaticColoringVariable {

  protected static final String VC_FILL_COLOR = "fillColor";

  private final String          defaultStaticColor;

  private String                fillColor;

  public StaticColoringVariable(String defaultStaticColor) {
    this.defaultStaticColor = defaultStaticColor;
    this.fillColor = defaultStaticColor;
  }

  public void configureFrom(ViewpointConfiguration vpConfig) {
    this.fillColor = vpConfig.get(getName()) != null ? vpConfig.get(getName()) : defaultStaticColor;
  }
