...
/**
 * This class is responsible for creation of an excel report for {@link BusinessProcess}es.
 */
public class BusinessProcessExcelReport extends ExcelReport {

  private Set<BusinessProcess> bpList;
   ...
   * @param bpList
   *          the {@link BusinessProcess}s for the report
   * @param queryData
   ...
   */
  public BusinessProcessExcelReport(ExportWorkbook context, BuildingBlockTypeDAO bbtDao, AttributeTypeDAO attributeTypeDAO,
      Set<BusinessProcess> bpList, ExcelAdditionalQueryData queryData, String serverURL) {
    this.init(context, bbtDao, attributeTypeDAO, queryData, TypeOfBuildingBlock.BUSINESSPROCESS, serverURL);
    this.bpList = bpList;
  }
  ...
  public ExportWorkbook createReport() {
    ...
    for (BusinessProcess bp : this.bpList) {
      allBDs.addAll(bp.getBusinessDomains());
      allBMs.addAll(bp.getBusinessMappings());
      ExcelHelper.extractContentsFromBMs(bp.getBusinessMappings(), null, allBUs, allISRs, allProducts);
    }
