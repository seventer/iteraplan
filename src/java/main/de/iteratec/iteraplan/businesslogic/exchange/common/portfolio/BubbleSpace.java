...
public class BubbleSpace {
  private PositionDimension xDimension;
  private PositionDimension yDimension;
  private SizeDimension     sizeDimension;
  private ColorDimension    colorDimension;

  /**
   * @return Returns the colorDimension.
   */
  ...
  /**
   * @return Returns the sizeDimension.
   */
  public SizeDimension getSizeDimension() {
    return sizeDimension;
  }

  /**
   * @param sizeDimension
   *          The sizeDimension to set.
   */
  public void setSizeDimension(SizeDimension sizeDimension) {
    this.sizeDimension = sizeDimension;
  }

  /**
   * @return Returns the xDimension.
   */
  public PositionDimension getXDimension() {
    return xDimension;
  }
   ...
   */
  public void setXDimension(PositionDimension dimension) {
    xDimension = dimension;
  }

  /**
   * @return Returns the yDimension.
   */
  public PositionDimension getYDimension() {
    return yDimension;
  }
   ...
   */
  public void setYDimension(PositionDimension dimension) {
