...
public class SimpleMessage implements Message, Serializable {
  ...
  private static final long serialVersionUID = -4137127165574977941L;

  private final Severity    severity;
  private final String      message;

  public SimpleMessage(Severity severity, String message) {
    this.severity = severity;
    this.message = message;
  }

  public SimpleMessage(ErrorLevel errorLevel, String message) {
    if (ErrorLevel.ERROR.equals(errorLevel)) {
      this.severity = Severity.ERROR;
    }
    else if (ErrorLevel.INFO.equals(errorLevel)) {
