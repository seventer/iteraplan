...
/**
 * User for self relationships of the outer and inner types.
 */
public class SelfRelationshipVariable {
  ...
  public SelfRelationshipVariable(RMetamodel metamodel, String name) {
  ...
  public void configureFrom(ViewpointConfiguration vpConfig) {
    ...
    if (boundaryHolderType != null && valueString != null) {
      try {
        this.value = IteraQl2Compiler.compile(metamodel, boundaryHolderType.getPersistentName() + "/" + valueString).getRight();
