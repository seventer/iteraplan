...
/**
 * This class represents an excel sheet with contents for {@link InformationSystemDomain}s.
 */
public class InformationSystemDomainExcelSheet extends CommonSheetContent<InformationSystemDomain> {

  private static final String SHEET_KEY = Constants.BB_INFORMATIONSYSTEMDOMAIN_PLURAL;
   ...
   */
  public InformationSystemDomainExcelSheet(Set<InformationSystemDomain> contents, ExportWorkbook context,
   ...
   */
  @Override
  protected void addSpecificLineContents(InformationSystemDomain isd, List<Object> lineContents) {
    if (isd == null) {
      return;
    }
    String isrNames = ExcelHelper.concatMultipleHierarchicalNames(isd.getInformationSystemReleases(), IN_LINE_SEPARATOR);
