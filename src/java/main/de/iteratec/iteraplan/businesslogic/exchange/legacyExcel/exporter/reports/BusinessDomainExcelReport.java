...
/**
 * This class is responsible for creation of an excel report for {@link BusinessDomain}s.
 */
public class BusinessDomainExcelReport extends ExcelReport {

  private Set<BusinessDomain> bdList;
   ...
   * @param bdList
   *          the {@link BusinessDomain}s for the report
   * @param queryData
   ...
   */
  public BusinessDomainExcelReport(ExportWorkbook context, BuildingBlockTypeDAO bbtDao, AttributeTypeDAO attributeTypeDAO,
      Set<BusinessDomain> bdList, ExcelAdditionalQueryData queryData, String serverURL) {
    this.init(context, bbtDao, attributeTypeDAO, queryData, TypeOfBuildingBlock.BUSINESSDOMAIN, serverURL);
    this.bdList = bdList;
  }
  ...
  public ExportWorkbook createReport() {
    ...
    for (BusinessDomain bd : this.bdList) {
      allBOs.addAll(bd.getBusinessObjects());
      allBPs.addAll(bd.getBusinessProcesses());
      allBFs.addAll(bd.getBusinessFunctions());
      allProducts.addAll(bd.getProducts());
      allBUs.addAll(bd.getBusinessUnits());
    }
