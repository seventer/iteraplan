...
/**
 * This class is responsible for creation of an excel report for {@link InfrastructureElement}s.
 */
public class InfrastructureElementExcelReport extends ExcelReport {

  private Set<InfrastructureElement> ieList;
   ...
   * @param ieList
   *          the {@link InfrastructureElement}s for the report
   * @param queryData
   ...
   */
  public InfrastructureElementExcelReport(ExportWorkbook context, BuildingBlockTypeDAO bbtDao, AttributeTypeDAO attributeTypeDAO,
      Set<InfrastructureElement> ieList, ExcelAdditionalQueryData queryData, String serverURL) {
    this.init(context, bbtDao, attributeTypeDAO, queryData, TypeOfBuildingBlock.INFRASTRUCTUREELEMENT, serverURL);
    this.ieList = ieList;
  }
  ...
  public ExportWorkbook createReport() {
    ...
    for (InfrastructureElement ie : this.ieList) {
      allTCRs.addAll(ie.getTechnicalComponentReleases());
      allISRs.addAll(ie.getInformationSystemReleases());
    }
