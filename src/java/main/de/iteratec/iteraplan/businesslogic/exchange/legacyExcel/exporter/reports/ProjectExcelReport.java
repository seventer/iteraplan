...
/**
 * This class is responsible for creation of an excel report for {@link Project}s.
 */
public class ProjectExcelReport extends ExcelReport {
   ...
   * @param projects
   *          the {@link Project}s for the report
   * @param queryData
   ...
   */
  public ProjectExcelReport(ExportWorkbook context, BuildingBlockTypeDAO bbtDao, AttributeTypeDAO attributeTypeDAO, Set<Project> projects,
      ExcelAdditionalQueryData queryData, String serverURL) {
    this.init(context, bbtDao, attributeTypeDAO, queryData, TypeOfBuildingBlock.PROJECT, serverURL);
  ...
  public ExportWorkbook createReport() {
    ...
    this.addProjectSheet(this.projects);
    ...
    for (Project project : this.projects) {
      allISRs.addAll(project.getInformationSystemReleases());
    }
