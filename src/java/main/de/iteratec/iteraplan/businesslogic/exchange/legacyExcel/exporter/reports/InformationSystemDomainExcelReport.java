...
/**
 * This class is responsible for creation of an excel report for {@link InformationSystemDomain}s.
 */
public class InformationSystemDomainExcelReport extends ExcelReport {

  private Set<InformationSystemDomain> isdList;
   ...
   * @param isdList
   *          the {@link InformationSystemDomain}s for the report
   * @param queryData
   ...
   */
  public InformationSystemDomainExcelReport(ExportWorkbook context, BuildingBlockTypeDAO bbtDao, AttributeTypeDAO attributeTypeDAO,
      Set<InformationSystemDomain> isdList, ExcelAdditionalQueryData queryData, String serverURL) {
    this.init(context, bbtDao, attributeTypeDAO, queryData, TypeOfBuildingBlock.INFORMATIONSYSTEMDOMAIN, serverURL);
  ...
  public ExportWorkbook createReport() {
    ...
    for (InformationSystemDomain isd : this.isdList) {
      allISRs.addAll(isd.getInformationSystemReleases());
    }
