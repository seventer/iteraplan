...
/**
 * A spring bean which implements the elasticMi Load Task Factory and makes it possible
 * to create implementation(iteraplan)-specific load tasks.
 */
public class IteraplanMiLoadTaskFactory implements ElasticMiLoadTaskFactory {
  ...
  /**{@inheritDoc}**/
  @Override
  public IteraplanMiLoadTask create(String dataStoreIdentifier) {
    return new IteraplanMiLoadTask(dataStoreIdentifier, attributeTypeGroupDAO, configuration, sessionFactory);
  }
