...
/**
 * Exposes several hibernate accessor methods which are otherwise protected.
 */
public class IteraplanMiHibernateAccessor extends HibernateAccessor {

  public IteraplanMiHibernateAccessor(SessionFactory sessionFactory) {
    setSessionFactory(sessionFactory);
    setFlushMode(FLUSH_NEVER);
  }

  public FlushMode applyFlushMode(Session session, boolean existingTransaction) {
