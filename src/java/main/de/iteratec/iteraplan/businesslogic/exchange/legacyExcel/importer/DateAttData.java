...
/**
 * Represents imported entry for the date attribute.
 * @author sip
 */
public class DateAttData extends AttData {
   ...
   * @param active
   */
  public DateAttData(CellValueHolder name, CellValueHolder oldName, CellValueHolder description, CellValueHolder groupName,
      CellValueHolder mandatory, CellValueHolder active) {
