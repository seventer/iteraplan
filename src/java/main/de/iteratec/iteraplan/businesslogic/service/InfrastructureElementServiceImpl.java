...
/**
 * Implementation of the service interface {@link InfrastructureElementService}.
 */
public class InfrastructureElementServiceImpl extends AbstractHierarchicalBuildingBlockService<InfrastructureElement> implements
    InfrastructureElementService {
  ...
  @Override
  protected void checkDelete(InfrastructureElement buildingBlock) {
    super.checkDelete(buildingBlock);
    checkDeletePermissionsCurrentPerms(buildingBlock);
  }

  @Override
  protected void onAfterDelete(InfrastructureElement buildingBlock) {
    getAttributeValueService().removeOrphanedAttributeValuesAndAssignments();
  }

  /** {@inheritDoc} */
  @Override
  protected DAOTemplate<InfrastructureElement, Integer> getDao() {
    return infrastructureElementDAO;
  }
  ...
  /** {@inheritDoc} */
  @Override
  public InfrastructureElement saveOrUpdate(InfrastructureElement entity, boolean cleanup) {
    getAttributeValueService().saveOrUpdateAttributeValues(entity);

    InfrastructureElement infrastructureElement = super.saveOrUpdate(entity, cleanup);
    tcr2IeAssociationService.saveAssociations(entity.getTechnicalComponentReleaseAssociations(), cleanup);
