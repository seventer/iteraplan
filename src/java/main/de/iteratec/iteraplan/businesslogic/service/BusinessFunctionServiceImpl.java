...
/**
 * Implementation of the service interface {@link BusinessFunctionService}.
 */
public class BusinessFunctionServiceImpl extends AbstractHierarchicalBuildingBlockService<BusinessFunction> implements BusinessFunctionService {

  private BusinessFunctionDAO businessFunctionDAO;

  @Override
  protected void checkDelete(BusinessFunction buildingBlock) {
    super.checkDelete(buildingBlock);
    checkDeletePermissionsCurrentPerms(buildingBlock);
  }

  @Override
  protected void onAfterDelete(BusinessFunction buildingBlock) {
  ...
  /** {@inheritDoc} */
  @Override
  protected DAOTemplate<BusinessFunction, Integer> getDao() {
    return businessFunctionDAO;
  }

  /** {@inheritDoc} */
  @Override
  public BusinessFunction saveOrUpdate(BusinessFunction entity, boolean cleanup) {
