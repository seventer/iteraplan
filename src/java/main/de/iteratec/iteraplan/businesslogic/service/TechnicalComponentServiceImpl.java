...
/**
 * Implementation of {@link TechnicalComponentService}.
 */
public class TechnicalComponentServiceImpl extends AbstractBuildingBlockService<TechnicalComponent> implements TechnicalComponentService {

  private TechnicalComponentDAO technicalComponentDAO;

  /** {@inheritDoc} */
  @Override
  protected DAOTemplate<TechnicalComponent, Integer> getDao() {
    return technicalComponentDAO;
  }
