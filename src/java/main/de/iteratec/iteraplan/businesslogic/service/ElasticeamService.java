...
/**
 * A simple service to provide an access point to the elasticEAM facilities.
 */
public interface ElasticeamService {
  ...
  QueryResult executeQuery(CompiledQuery query);
