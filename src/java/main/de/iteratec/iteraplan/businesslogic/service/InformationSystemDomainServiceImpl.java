...
/**
 * Implementation of the service interface {@link InformationSystemDomainService}.
 */
public class InformationSystemDomainServiceImpl extends AbstractHierarchicalBuildingBlockService<InformationSystemDomain> implements
    InformationSystemDomainService {

  private InformationSystemDomainDAO informationSystemDomainDAO;

  @Override
  protected void checkDelete(InformationSystemDomain buildingBlock) {
    super.checkDelete(buildingBlock);
    checkDeletePermissionsCurrentPerms(buildingBlock);
  }

  @Override
  protected void onAfterDelete(InformationSystemDomain buildingBlock) {
  ...
  /** {@inheritDoc} */
  @Override
  protected DAOTemplate<InformationSystemDomain, Integer> getDao() {
    return this.informationSystemDomainDAO;
  }

  /** {@inheritDoc} */
  @Override
  public InformationSystemDomain saveOrUpdate(InformationSystemDomain entity, boolean cleanup) {
