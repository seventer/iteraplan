...
/**
 * The meta model describing the type {@link InfrastructureElement}.
 */
public abstract class InfrastructureElementType extends Type<InfrastructureElement> {

  private static final long  serialVersionUID                                   = 2626131070428210236L;
  ...
  public static final String ASSOCIATION_TECHNICALCOMPONENTRELEASE_ASSOCIATIONS = "technicalComponentReleaseAssociations";

  public TypeOfBuildingBlock getTypeOfBuildingBlock() {
    return TypeOfBuildingBlock.INFRASTRUCTUREELEMENT;
  }

  public InfrastructureElementType(String typeNameDB, String typeNameDBShort) {
    super(typeNameDB, typeNameDBShort, Constants.BB_INFRASTRUCTUREELEMENT, Constants.BB_INFRASTRUCTUREELEMENT_PLURAL);
  }

  public InfrastructureElementType() {
    super(Constants.BB_INFRASTRUCTUREELEMENT, Constants.BB_INFRASTRUCTUREELEMENT_PLURAL);
  }
