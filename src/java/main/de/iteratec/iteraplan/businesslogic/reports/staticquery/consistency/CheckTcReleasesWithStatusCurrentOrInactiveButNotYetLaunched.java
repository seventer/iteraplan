...
public class CheckTcReleasesWithStatusCurrentOrInactiveButNotYetLaunched extends AbstractConsistencyCheck {

  public CheckTcReleasesWithStatusCurrentOrInactiveButNotYetLaunched() {
    super("check_technical_tcrWithStatusCurrentOrInactiveButNotYetLaunched", Domain.TECHNICAL);
  }

  @Override
  public Result executeCheck(Map<String, Parameter> parameters) {
    List<TechnicalComponentRelease> releases = getConsistencyCheckDAO().getTcReleasesWithStatusCurrentOrInactiveButNotYetLaunched();
  ...
  protected List<ResultColumn> configureColumns() {
    return doConfigureColumns(Constants.BB_TECHNICALCOMPONENTRELEASE);
  }
}