 ...
 * than CURRENT.
 */
public class CheckTcrSharingNoArchitecturalDomainWithTheirSuccessors extends AbstractConsistencyCheck {

  public CheckTcrSharingNoArchitecturalDomainWithTheirSuccessors() {
    super("check_technical_tcrSharingNoArchitecturalDomainWithTheirSuccessors", Domain.TECHNICAL);
  }
  ...
  public Result executeCheck(Map<String, Parameter> parameters) {
    ...
    // }
    List<Object[]> list = getConsistencyCheckDAO().getTechnicalComponentReleasesSharingNoArchitecturalDomainWithTheirSuccessors();
