...
/**
 * The meta model describing the type {@link BusinessFunction}.
 */
public abstract class BusinessFunctionType extends Type<BusinessFunction> {

  private static final long  serialVersionUID             = -820369650790886931L;
  public static final String PROPERTY_NAME                = "name";
  public static final String PROPERTY_DESCRIPTION         = "description";

  public static final String ASSOCIATION_INFORMATIONSYSTEMS = "informationSystems";
  ...
  BusinessFunctionType(String typeNameDB, String typeNameDBShort) {
    super(typeNameDB, typeNameDBShort, Constants.BB_BUSINESSFUNCTION, Constants.BB_BUSINESSFUNCTION_PLURAL);
  }

  BusinessFunctionType() {
    super(Constants.BB_BUSINESSFUNCTION, Constants.BB_BUSINESSFUNCTION_PLURAL);
  }
