...
/**
 * The meta model describing the type {@link BusinessMapping}.
 */
public abstract class BusinessMappingType extends Type<BusinessMapping> {

  private static final long serialVersionUID = 8124804606938566889L;
  ...
  BusinessMappingType(String typeNameDB, String typeNameDBShort) {
    super(typeNameDB, typeNameDBShort, Constants.BB_BUSINESSMAPPING, Constants.BB_BUSINESSMAPPING_PLURAL);
  }

  BusinessMappingType() {
    super(Constants.BB_BUSINESSMAPPING, Constants.BB_BUSINESSMAPPING_PLURAL);
  }
