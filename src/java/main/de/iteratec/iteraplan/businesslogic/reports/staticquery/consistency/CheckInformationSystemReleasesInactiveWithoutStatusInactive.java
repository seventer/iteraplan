...
public class CheckInformationSystemReleasesInactiveWithoutStatusInactive extends AbstractConsistencyCheck {
  public CheckInformationSystemReleasesInactiveWithoutStatusInactive() {
    super("check_ir_isrInactiveWithoutStatusInactive", Domain.IT);
  }

  @Override
  public Result executeCheck(Map<String, Parameter> parameters) {
    List<InformationSystemRelease> releases = getConsistencyCheckDAO().getInformationSystemReleasesInactiveWithoutStatusInactive();
