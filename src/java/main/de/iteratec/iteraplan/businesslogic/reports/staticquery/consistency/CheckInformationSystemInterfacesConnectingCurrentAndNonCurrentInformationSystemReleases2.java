...
/**
 * This consistency check checks if there are releases of information systems that are connected with an
 * interface, but there is any given time in which either is not active, while the other is.
 */
public class CheckInformationSystemInterfacesConnectingCurrentAndNonCurrentInformationSystemReleases2 extends AbstractConsistencyCheck {
  public CheckInformationSystemInterfacesConnectingCurrentAndNonCurrentInformationSystemReleases2() {
    super("check_it_isiConnectingCurrentAndNonCurrentInformationSystemReleases2", Domain.IT);
  }
  ...
  public Result executeCheck(Map<String, Parameter> parameters) {
    ...
    for (InformationSystemInterface interf : list) {
      ...
      row.add(interf.getInformationSystemReleaseA().runtimeEndsAt());
      ...
      row.add(interf.getInformationSystemReleaseB().runtimeEndsAt());
