...
public class CheckBoUsedByInformationSystemButNotTransported extends AbstractConsistencyCheck {

  public CheckBoUsedByInformationSystemButNotTransported() {
    super("check_it_boUsedByInformationSystemButNotTransported", Domain.IT);
  }
  ...
  protected List<ResultColumn> configureColumns() {
    ...
    columns.add(new ResultColumn(Constants.BB_BUSINESSOBJECT, DataType.OBJECT, "identityString", Boolean.TRUE, Boolean.FALSE));
  ...
  public Result executeCheck(Map<String, Parameter> parameters) {
    ...
    List<Pair<BusinessObject, InformationSystemRelease>> list = getConsistencyCheckDAO().getBoUsedByInformationSystemButNotTransported();

    for (Pair<BusinessObject, InformationSystemRelease> pair : list) {
