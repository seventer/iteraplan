...
public abstract class BusinessUnitType extends Type<BusinessUnit> {

  private static final long  serialVersionUID             = -3648787508860510091L;
  ...
  BusinessUnitType(String typeNameDB, String typeNameDBShort) {
    super(typeNameDB, typeNameDBShort, Constants.BB_BUSINESSUNIT, Constants.BB_BUSINESSUNIT_PLURAL);
  }

  BusinessUnitType() {
    super(Constants.BB_BUSINESSUNIT, Constants.BB_BUSINESSUNIT_PLURAL);
  }
