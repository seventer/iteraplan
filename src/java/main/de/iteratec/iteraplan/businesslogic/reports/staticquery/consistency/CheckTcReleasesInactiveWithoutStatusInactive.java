...
public class CheckTcReleasesInactiveWithoutStatusInactive extends AbstractConsistencyCheck {

  public CheckTcReleasesInactiveWithoutStatusInactive() {
    super("check_technical_tcrInactiveWithoutStatusInactive", Domain.TECHNICAL);
  }

  @Override
  public Result executeCheck(Map<String, Parameter> parameters) {
    List<TechnicalComponentRelease> releases = getConsistencyCheckDAO().getTcReleasesInactiveWithoutStatusInactive();
