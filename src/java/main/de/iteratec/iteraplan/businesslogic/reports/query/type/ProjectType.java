...
/**
 * The meta model describing the type {@link Project}.
 */
public abstract class ProjectType extends Type<Project> {

  private static final long serialVersionUID = -7897538751418555713L;
  ...
  ProjectType(String typeNameDB, String typeNameDBShort) {
    super(typeNameDB, typeNameDBShort, Constants.BB_PROJECT, Constants.BB_PROJECT_PLURAL);
  }

  ProjectType() {
    super(Constants.BB_PROJECT, Constants.BB_PROJECT_PLURAL);
  }
