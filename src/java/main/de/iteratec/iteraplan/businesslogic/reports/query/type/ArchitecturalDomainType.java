...
public abstract class ArchitecturalDomainType extends Type<ArchitecturalDomain> {

  private static final long  serialVersionUID                       = 6155594450861685289L;
  ...
  ArchitecturalDomainType(String typeNameDB, String typeNameDBShort) {
    super(typeNameDB, typeNameDBShort, Constants.BB_ARCHITECTURALDOMAIN, Constants.BB_ARCHITECTURALDOMAIN_PLURAL);
  }

  ArchitecturalDomainType() {
    super(Constants.BB_ARCHITECTURALDOMAIN, Constants.BB_ARCHITECTURALDOMAIN_PLURAL);
  }
