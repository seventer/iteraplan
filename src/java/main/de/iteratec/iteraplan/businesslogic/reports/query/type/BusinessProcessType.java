...
/**
 * The meta model describing the type {@code BusinessProcess}.
 */
public abstract class BusinessProcessType extends Type<BusinessProcess> {

  private static final long  serialVersionUID             = 6746467797985171427L;
  ...
  BusinessProcessType(String typeNameDB, String typeNameDBShort) {
    super(typeNameDB, typeNameDBShort, Constants.BB_BUSINESSPROCESS, Constants.BB_BUSINESSPROCESS_PLURAL);
  }

  BusinessProcessType() {
    super(Constants.BB_BUSINESSPROCESS, Constants.BB_BUSINESSPROCESS_PLURAL);
  }
