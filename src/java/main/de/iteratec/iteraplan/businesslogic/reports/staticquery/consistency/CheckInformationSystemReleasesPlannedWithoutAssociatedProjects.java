...
/**
 * Checks if there are {@link InformationSystemRelease}s with status PLANNED, that are not part of
 * any {@code Project}.
 */
public class CheckInformationSystemReleasesPlannedWithoutAssociatedProjects extends AbstractConsistencyCheck {

  public CheckInformationSystemReleasesPlannedWithoutAssociatedProjects() {
    super("check_it_isrPlannedWithoutAssociatedProjects", Domain.IT);
  }

  @Override
  public Result executeCheck(Map<String, Parameter> parameters) {

    List<InformationSystemRelease> releases = getConsistencyCheckDAO().getInformationSystemReleasesPlannedWithoutAssociatedProjects();
