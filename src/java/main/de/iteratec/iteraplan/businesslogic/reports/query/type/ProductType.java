...
public abstract class ProductType extends Type<Product> {

  private static final long  serialVersionUID             = -5373204185642504002L;
  ...
  ProductType(String typeNameDB, String typeNameDBShort) {
    super(typeNameDB, typeNameDBShort, Constants.BB_PRODUCT, Constants.BB_PRODUCT_PLURAL);
  }

  ProductType() {
    super(Constants.BB_PRODUCT, Constants.BB_PRODUCT_PLURAL);
  }
