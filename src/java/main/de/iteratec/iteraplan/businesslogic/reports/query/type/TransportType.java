...
public abstract class TransportType extends Type<Transport> {

  public static final String ASSOCIATION_BUSINESSOBJECT = "businessObject";

  public TransportType(String typeNameDB, String typeNameDBShort, String typeNamePresentationKey, String typeNamePluralPresentationKey) {
    super(typeNameDB, typeNameDBShort, typeNamePresentationKey, typeNamePluralPresentationKey);
  }
  ...
  /* (non-Javadoc)
   * @see de.iteratec.iteraplan.businesslogic.reports.query.type.Type#initProperties()
   */
  @Override
  void initProperties() {
    // nothing to do here
