...
/**
 * The backing bean for query data about the status of a {@code InformationSystemRelease}.
 */
public class QStatusDataInformationSystemRelease extends AbstractQStatusData<TypeOfStatus> {

  /** Serialization version. */
  private static final long serialVersionUID = -6482958805592753068L;
   ...
   */
  public QStatusDataInformationSystemRelease() {
    setStatusMap(getStatusData());
  }

  private Map<TypeOfStatus, Boolean> getStatusData() {
    Map<TypeOfStatus, Boolean> resultMap = Maps.newLinkedHashMap();
