 ...
 * @author mma
 */
public class ArchitecturalDomainDAOImplTest extends BaseTransactionalTestSupport {

  private static final String        TEST_DESCRIPTION = "testDescription";
  @Autowired
  private ArchitecturalDomainDAOImpl classUnderTest;
  @Autowired
  ...
  /**
   * Test method for
   * {@link de.iteratec.iteraplan.persistence.dao.ArchitecturalDomainDAOImpl#onBeforeDelete(de.iteratec.iteraplan.model.ArchitecturalDomain)}
   */
  @Test
  public void testOnBeforeDelete() {
    ArchitecturalDomain entity = testDataHelper.createArchitecturalDomain("testAD", TEST_DESCRIPTION);
    ArchitecturalDomain parent = testDataHelper.createArchitecturalDomain("parentAD", TEST_DESCRIPTION);
    ...
    ArchitecturalDomain firstChild = testDataHelper.createArchitecturalDomain("firstChildAD", TEST_DESCRIPTION);
    ArchitecturalDomain secChild = testDataHelper.createArchitecturalDomain("secChildAD", TEST_DESCRIPTION);
    ArchitecturalDomain thirdChild = testDataHelper.createArchitecturalDomain("thirdChildAD", TEST_DESCRIPTION);
    commit();

    Set<TechnicalComponentRelease> setTCRs = hashSet();
    setTCRs.add(tcr);

    beginTransaction();
    firstChild.setTechnicalComponentReleases(setTCRs);
    secChild.setTechnicalComponentReleases(setTCRs);
    thirdChild.setTechnicalComponentReleases(setTCRs);
    commit();
    ...
    beginTransaction();
    entity.addTechnicalComponentReleases(setTCRs);
    ...
    ArchitecturalDomain actualParent = entity.getParent();
    ...
    List<ArchitecturalDomain> actualChildren = entity.getChildren();
    ...
    assertEquals(expectedTCRs, firstChild.getTechnicalComponentReleases());
    assertEquals(expectedTCRs, secChild.getTechnicalComponentReleases());
    assertEquals(expectedTCRs, thirdChild.getTechnicalComponentReleases());
