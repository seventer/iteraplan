...
public class InformationSystemReleaseMemBeanSerializationTest {

  @Test
  public void testSerialization() {
    MemBean<?, ?> originalMemBean = new InformationSystemReleaseMemBean();
    MemBeanSerializationTestHelper.testSerializeDeserialize(originalMemBean);
    MemBeanSerializationTestHelper.testComponentModelPresence(originalMemBean);
  }
