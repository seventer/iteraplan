 ...
 *
 */
public class BusinessProcessMappingStrategyTest {

  private final BusinessMappingStrategy mappingStrategy = BusinessMappingStrategyFactory.getStrategyFor(BusinessProcess.class);
  ...
  public void testCreateBusinessMappings() {
    ...
    final List<BusinessProcess> bps = Lists.newArrayList();
  ...
  public void testAddOwningEntity() {
    ...
    Assert.assertEquals(bp, businessMapping.getBusinessProcess());
    Assert.assertThat(bp.getBusinessMappings(), JUnitMatchers.hasItem(businessMapping));
  }
