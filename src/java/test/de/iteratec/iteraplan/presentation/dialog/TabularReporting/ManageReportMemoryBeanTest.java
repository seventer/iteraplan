...
public class ManageReportMemoryBeanTest extends BaseTransactionalTestSupport {

  @Autowired
  private InitFormHelperService service;

  @Test
  public void testSerialization() {
    ManageReportMemoryBean originalMemBean = service.getInitializedReportMemBean(Constants.BB_ARCHITECTURALDOMAIN_PLURAL);
