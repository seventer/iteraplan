...
@ContextConfiguration("/applicationContext-mockImport.xml")
public class DataResourceGetTest extends ADataResourceTest {
  ...
  @Test
  public void testGetDataXLS() {
    setupUserContext();

    Response response = getResponse(url, Method.GET, ImmutableMap.<String, Object> of(IteraplanRestApplication.KEY_FORMAT, "xls"));

    Representation entity = response.getEntity();

    Assert.assertEquals(Status.SUCCESS_OK, response.getStatus());
    Assert.assertTrue(entity instanceof OutputRepresentation);
  }

  @Test
  public void testGetDataXLSX() {
    setupUserContext();

    Response response = getResponse(url, Method.GET, ImmutableMap.<String, Object> of(IteraplanRestApplication.KEY_FORMAT, "xlsx"));
  ...
  @Test
  public void testGetDataWithoutPermissions() {
    setupUserContextWithoutPermissions();
