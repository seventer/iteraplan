...
/**
 * The second page (step 2) of configuring a cluster diagram
 */
public class ClusterDiagram2Page extends AbstractContentPage {

  private By downloadButtonLocator         = By.id("generateExport");
   ...
   * @param driver
   */
  public ClusterDiagram2Page(WebDriver driver) {
    super(driver);
  }

  public void clickDownloadButton() {
    driver.findElement(downloadButtonLocator).click();
    //a short delay while file is prepared
