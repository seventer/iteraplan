...
/**
 * Represents the Panel for Information System in Consistency Check Context
 */
public class ConsistencyCheckInformationSystemPanel extends AbstractPanel {

  private By executeAllLocator        = By.xpath("//*[@id=\"mainContent\"]/div[1]/div[1]/input");
  private By countEntries             = By.xpath("//*[@id=\"mainContent\"]/div[1]/div[2]/div/div/table/tbody/tr");
   ...
   * @param driver
   */
  public ConsistencyCheckInformationSystemPanel(WebDriver driver) {
    super(driver);
  }
  ...
  public void executeCheck(int number) {
    ...
    String executeButtonXpath = "//*[@id=\"mainContent\"]/div[1]/div[2]/div/div/table/tbody/tr[" + number + "]/td[3]/input";
  ...
  public void executeAllChecks() {
    driver.findElement(executeAllLocator).click();
  }
