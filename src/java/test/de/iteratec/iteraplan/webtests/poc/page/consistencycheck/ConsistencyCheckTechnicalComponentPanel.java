...
/**
 * Represents the Panel for Technical Components in Consistency Check Context
 */
public class ConsistencyCheckTechnicalComponentPanel extends AbstractPanel {

  private By countEntries             = By.xpath("//*[@id=\"mainContent\"]/div[2]/div[2]/div/div/table/tbody/tr");
   ...
   * @param driver
   */
  public ConsistencyCheckTechnicalComponentPanel(WebDriver driver) {
    super(driver);
  }
  ...
  public void executeCheck(int number) {
    ...
    String executeButtonXpath = "//*[@id=\"mainContent\"]/div[2]/div[2]/div/div/table/tbody/tr[" + number + "]/td[3]/input";
