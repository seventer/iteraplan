...
public class SimpleDeleteDiff extends ObjectDiffImpl implements DeleteDiff {
  private final ObjectExpression oe;

  protected SimpleDeleteDiff(RStructuredTypeExpression type, ObjectExpression oe) {
    super(type);
    this.oe = oe;
  }
