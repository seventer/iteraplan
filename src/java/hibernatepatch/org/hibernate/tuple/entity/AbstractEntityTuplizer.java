 ...
 * @author Gavin King
 */
@SuppressWarnings("PMD") // do not want to change more than necessary
public abstract class AbstractEntityTuplizer implements EntityTuplizer {

  private static final Logger LOGGER = LoggerFactory.getLogger( AbstractEntityTuplizer.class );
  ...
  public AbstractEntityTuplizer(EntityMetamodel entityMetamodel, PersistentClass mappingInfo) {
    ...
    if ( entityMetamodel.isLazy() ) {
      ...
      proxyFactory = buildProxyFactory( mappingInfo, idGetter, idSetter ); //Fix for HHH-3854
    }
        ...
        if ( subTypes[i].isAssociationType() && ! copierSubTypes[i].isAssociationType() ) {
          ...
          if ( HibernateProxy.class.isInstance( propertyValues[i] ) ) {
            ...
            if ( pcEntry != null ) {
              ...
              LOGGER.debug( "Performing implicit derived identity cascade" );
