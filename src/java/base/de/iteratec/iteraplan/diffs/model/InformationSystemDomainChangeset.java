...
public class InformationSystemDomainChangeset extends HierarchicalEntityChangeset {
   ...
   * @param timestamp
   */
  public InformationSystemDomainChangeset(Integer bbId, TypeOfBuildingBlock tobb, String author, DateTime timestamp) {
