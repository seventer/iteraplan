...
public class ArchitecturalDomainChangeset extends HierarchicalEntityChangeset {
  ...
  public ArchitecturalDomainChangeset(Integer bbId, TypeOfBuildingBlock tobb, String author, DateTime timestamp) {
