...
public class BusinessProcessChangeset extends HierarchicalEntityChangeset {
   ...
   * @param timestamp
   */
  public BusinessProcessChangeset(Integer bbId, TypeOfBuildingBlock tobb, String author, DateTime timestamp) {
