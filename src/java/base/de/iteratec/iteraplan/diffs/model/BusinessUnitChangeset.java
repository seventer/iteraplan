...
public class BusinessUnitChangeset extends HierarchicalEntityChangeset {
   ...
   * @param timestamp
   */
  public BusinessUnitChangeset(Integer bbId, TypeOfBuildingBlock tobb, String author, DateTime timestamp) {
