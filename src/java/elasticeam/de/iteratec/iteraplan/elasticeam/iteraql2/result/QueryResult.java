...
public interface QueryResult {
  ...
  /**
   * @return
   *    The query which was executed to obtain this result.
   */
  CompiledQuery getSourceQuery();
  ...
  /**
   * Captures the supported query result types.
   */
  public enum QueryResultType {
    UNIVERSAL_TYPE, RELATIONSHIP_END;
  }
