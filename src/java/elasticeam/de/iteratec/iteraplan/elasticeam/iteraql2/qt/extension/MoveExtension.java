...
/**
 * A query tree element which represents the move operator.
 */
public class MoveExtension implements Extension {

  private List<MoveExtensionProperty> properties;

  public MoveExtension(List<MoveExtensionProperty> properties) {
