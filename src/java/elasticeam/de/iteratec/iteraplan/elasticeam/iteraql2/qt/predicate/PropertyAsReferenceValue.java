...
/**
 * A query tree element which represents a property used as a reference value in a predicate leaf.
 */
public class PropertyAsReferenceValue extends PredicateLeafReferenceValue {

  private PredicateLeafProperty property;

  public PropertyAsReferenceValue(PredicateLeafProperty property) {
