...
public class EMFRelationshipEnd extends EMFFeature<EReference, UniversalTypeExpression> implements RelationshipEndExpression {
   ...
   * @param metamodel
   */
  EMFRelationshipEnd(EReference wrapped, EMFMetamodel metamodel) {
    super(wrapped, metamodel);
  }

  EMFRelationshipEnd(EReference wrapped, UniversalTypeExpression source, EMFMetamodel metamodel) {
  ...
  public RelationshipExpression getRelationship() {
    return getMetamodelImpl().getRelationship(this);
  }

  /**{@inheritDoc}**/
  public final UniversalTypeExpression getType() {
    return getMetamodelImpl().encapsulate(getWrapped().getEReferenceType());
  }
