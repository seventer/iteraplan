...
public class EMFEnumerationLiteral extends EMFNamedElement<EEnumLiteral> implements EnumerationLiteralExpression {
   ...
   * @param metamodel
   */
  EMFEnumerationLiteral(EEnumLiteral wrapped, EMFMetamodel metamodel, Color defaultLiteralColor) {
  ...
  public EnumerationExpression getOwner() {
    return getMetamodelImpl().encapsulate(getWrapped().getEEnum());
  }
