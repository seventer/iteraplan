...
public class EMFRelationshipType extends EMFUniversalType implements RelationshipTypeExpression {
   ...
   * @param metamodel
   */
  EMFRelationshipType(EClass wrapped, EMFMetamodel metamodel) {
