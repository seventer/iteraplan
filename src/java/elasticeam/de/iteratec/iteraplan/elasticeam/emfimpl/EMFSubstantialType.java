...
public class EMFSubstantialType extends EMFUniversalType implements SubstantialTypeExpression {
   ...
   * @param metamodel
   */
  public EMFSubstantialType(EClass wrapped, EMFMetamodel metamodel) {
