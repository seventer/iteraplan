 ...
 *
 */
final class DecoratedSubstantialType extends DecoratedUniversalType<SubstantialTypeExpression> implements SubstantialTypeExpression {

  /**
   * Default constructor.
   * @param wrapped
   */
  DecoratedSubstantialType(SubstantialTypeExpression wrapped, Function<UniversalTypeExpression, UniversalTypeExpression> replacer) {
    super(wrapped, replacer);
  }

  /**{@inheritDoc}**/
  public Set<MixinTypeExpression> getMixins() {
    return getWrapped().getMixins();
  }
