...
public class PowerInstanceHandler extends ADerivedHandler implements InstanceHandler {

  public PowerInstanceHandler(Model model) {
    super(model);
  }
  ...
  public Collection<InstanceExpression> findAll(SubstantialTypeExpression type) {
    ...
    result.add(new PowerInstanceExpression(getModel(), (PowerSubstantialType) type));
  ...
  public boolean isHandlerFor(SubstantialTypeExpression type) {
    return PowerSubstantialType.class.isInstance(type);
  }

  /**{@inheritDoc}**/
  public boolean isHandlerFor(InstanceExpression instance) {
    return PowerInstanceExpression.class.isInstance(instance);
  }
