...
public final class CountProperty extends PrimitivePropertyImpl {

  private FeatureExpression<?> feature;

  public CountProperty(FeatureExpression<?> feature) {
    super("count(" + feature.getPersistentName() + ")", feature.getHolder(), 1, 1, BuiltinPrimitiveType.INTEGER);
