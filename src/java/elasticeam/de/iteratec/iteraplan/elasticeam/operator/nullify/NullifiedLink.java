...
public class NullifiedLink extends NullifiedModelExpression implements LinkExpression {

  protected NullifiedLink(Model model, NullifiedRelationshipType representedTypeNull) {
    super(model, representedTypeNull);
  }

  /**{@inheritDoc}**/
  public Object getValue(PropertyExpression<?> property) {
    // Has no value for any property
    return null;
  }
