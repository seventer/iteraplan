...
/**
 * Implementations of this class are predefined features in elasticEAM.
 */
public abstract class BuiltinFeature<T extends TypeExpression> extends FinalNamedExpressionImpl implements FeatureExpression<T> {

  private String                  persistentName;
  private int                     lowerBound;
  private int                     upperBound;
  private UniversalTypeExpression origin;
   ...
   * @param origin the origin universal type
   */
  public BuiltinFeature(String persistentName, int lowerBound, int upperBound, UniversalTypeExpression origin) {
  ...
  public int compareTo(FeatureExpression o) {
