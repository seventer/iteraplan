 ...
 *
 */
public class EnumerationLiteralImpl extends NamedExpressionImpl implements EnumerationLiteralExpression {

  private final EnumerationExpression owner;
   ...
   * Default constructor.
   */
  public EnumerationLiteralImpl(EnumerationExpression owner, String persistentName, Color defaultLiteralColor) {
    this.persistentName = persistentName;
    this.owner = owner;
    setName(persistentName);
    if (defaultLiteralColor != null) {
      this.defaultColor = defaultLiteralColor;
    }
  }
  ...
  /**{@inheritDoc}**/
  public final EnumerationExpression getOwner() {
    return this.owner;
  }
