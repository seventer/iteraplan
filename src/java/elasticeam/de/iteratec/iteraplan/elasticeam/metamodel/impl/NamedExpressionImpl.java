...
public abstract class NamedExpressionImpl implements NamedExpression {
  ...
  public final String getName() {
    return this.getName(ElasticeamContextUtil.getCurrentContext().getLocale());
  }
  ...
  public void setName(String name) {
    this.name.set(ElasticeamContextUtil.getCurrentContext().getLocale(), name);
  }
