...
/**
 * A primitive property predefined for a given type in elasticEAM.
 */
public class BuiltinPrimitiveProperty extends BuiltinFeature<PrimitiveTypeExpression> implements PrimitivePropertyExpression {

  private PrimitiveTypeExpression type;
   ...
   */
  public BuiltinPrimitiveProperty(String persistentName, int lowerBound, int upperBound, PrimitiveTypeExpression type, UniversalTypeExpression source) {
